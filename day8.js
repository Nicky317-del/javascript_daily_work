...
//Q1. Select the section with the ID 'profile' and change its background color to #f5f5f5, add padding of 15px and center the text.
...
console.log("Total important paragraphs:", importantParagraphs.length);s